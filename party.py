...
def is_mel(name, email):
    ...
    False
    >>> is_mel('Mel Melitpolski', 'sara@ubermelon.com')
    True
    >>> is_mel('Linda Melitpolski', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type(treats_most_common_tie)
    ('dessert', 'drink')
    ...
    >>> most_and_least_common_type(treats_all_unique)
    ('dessert', 'drink')
